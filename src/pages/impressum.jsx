...
const Wrapper = styled.div`
  ${tw`w-full xl:w-2/3 text-xl`};
`

const Backbutton = styled.a`
  ${tw`fixed pin-b pin-x cursor-pointer font-sans font-semibold py-4 px-8 border-none rounded content-center block text-center`};
        ...
        <>
            ...
            <Content full>
                <Wrapper>
                    ...
                    <p>Christoph Flick <br />
                        Neuheim  17<br />
                        48155 Münster <br />
                    </p><p> <strong>Vertreten durch: </strong><br />
                        Christoph Flick<br />
                    </p><p><strong>Kontakt:</strong> <br />
                        E-Mail: <a href='mailto:contact@christophflick.de'>contact@christophflick.de</a><br /></p><p><strong>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</strong><br />
                        Christoph Flick <br />
                        Neuheim  17<br />
                        48155 Münster <br /></p> <p><strong>Haftungsausschluss: </strong><br /><br /><strong>Haftung für Inhalte</strong><br /><br />
